    ...
    public function run(): void
    {
        ...
        $nuevosEspacios = [
            [
                ...
                'imagen' => '1773753644_gym-ua.jpg', 'lat' => 38.384, 'lon' => -0.513, 'piso' => -1
            ],
            [
                ...
                'imagen' => '1773753885_futbol-ua.jpg', 'lat' => 38.3835, 'lon' => -0.5115, 'piso' => 0
            ],
            [
                'nombre' => 'Campo de hockey', 'aforo' => 12, 'estado' => 'HABILITADO',
                'caracteristicas' => 'Hierba artificial, de 90 x 55 m, con iluminación',
                'imagen' => '1773753972_hockey-ua.jpg', 'lat' => 38.3825, 'lon' => -0.5125, 'piso' => 0
            ],
            [
                ...
                'imagen' => '1773754042_semicubierta-ua.jpg', 'lat' => 38.3845, 'lon' => -0.514, 'piso' => 0
            ],
            [
            ...
            [
                ...
                'imagen' => '1773754430_vestuarios-semicubierta-ua.jpg', 'lat' => 38.387, 'lon' => -0.517, 'piso' => 4
            ],
            [
                'nombre' => 'Circuito natural', 'aforo' => 200, 'estado' => 'HABILITADO',
                'caracteristicas' => 'Pista de arena de unos 700 m y aparatos de gimnasia',
                'imagen' => '1773754490_circuito-natural-ua.jpg', 'lat' => 38.3835, 'lon' => -0.512, 'piso' => 3
            ]
        ];

        foreach ($nuevosEspacios as $index => $datos) {

            // Verificamos si la localización ya existe
            ...
            if (!$loc) {
                // Solo creamos la localización si no existe
