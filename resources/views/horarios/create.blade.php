        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0 text-center">
                    <h1 class="h4 mb-0" style="color: #003366;">Añadir Nuevo Horario</h1>
                </div>
                    ...
                    <form action="{{ route('horarios.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="time" name="inicio" value="{{ old('inicio') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="time" name="fin" value="{{ old('fin') }}"
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn text-white" style="background-color: #003366;">Guardar Horario</button>
                        </div>
                    </form>
                </div>
            </div>
